...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/cart` | `/checkout` | `/menu`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/item/${SingleRoutePart<T>}` | `/order-confirmation/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/item/[id]` | `/order-confirmation/[id]`;
