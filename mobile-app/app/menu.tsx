    ...
    <View style={{ flex: 1 }}>
              ...
              <View style={s.cardInfo}>
                ...
                <View style={s.cardBottom}>
                  ...
                  <View style={s.addPill}>
                    <Text style={s.addPillTxt}>Customize →</Text>
                  </View>
                </View>
              </View>
            </TouchableOpacity>
      ...
      {cartCount > 0 && (
        <TouchableOpacity
          ...
          activeOpacity={0.9}
        >
          <Text style={s.cartBarTxt}>🛒 Cart ({cartCount})</Text>
...
const s = StyleSheet.create({
  ...
  addPillTxt: { color: '#fff', fontSize: 11, fontWeight: '700' },
  cartBar: {
    position: 'absolute',
    bottom: 16,
    left: 16,
